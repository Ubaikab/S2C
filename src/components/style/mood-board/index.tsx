...
const MoodBoard = ({ guideImages }: Props) => {
    ...
    return (
        <div className="flex flex-col gap-10 ">
            <div
                className={cn(
                    "relative w-full border-2 border-dashed rounded-3xl p-12 text-center transition-all duration-200 min-h-[400px] flex items-center justify-center",
                    dragActive
            ...
            {images.length >= 5 && (
                <div className="text-center p-4 bg-primary rounded-2xl">
                    <p className="px-4 rounded-xl text-sm  text-black font-semibold">
