  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-3 p-6 fixed top-0 left-0 right-0 z-50">
      ...
      <div className="flex items-center gap-4">
        ...
        {!hasCanvas ||
          (!hasStyleGuide && (
            <div className="hidden lg:inline-block rounded-full text-primary/60 border border-white/[0.12] backdrop-blur-xl bg-white/[0.08] px-4 py-2 text-sm saturate-150">
